...
export default function ReportPage(){
  ...
  const [advisorUid, setAdvisorUid] = useState('') // auth uid
  ...
  useEffect(()=>{ (async()=>{
    ...
    try{
      ...
      // se la vista non espone 'appuntamenti' → li calcolo
...
function mergeByMonth(
  ...
  // Normalizzo mappe: accetto righe che combaciano per advisor_user_id=uid OPPURE advisor_id=id
